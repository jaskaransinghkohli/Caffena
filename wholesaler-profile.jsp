...
<body>
	...
	<h2 align="center">Wholesaler Detail</h2><hr>
<br><br><br><br>	
	 <div class="row">
	 
	 <div class="col-md-2">Name:</div>
	 <div class="col-md-4">${WHOLESALE.name}</div>
	 <div class="col-md-2">Contact Number:</div>
	 <div class="col-md-4">${WHOLESALE.contact_number}</div>
	 </div>
	<br>
	<div class="row">
	 
	 <div class="col-md-2">Email:</div>
	 <div class="col-md-4">${WHOLESALE.email_id}</div>
	 <div class="col-md-2">Company:</div>
	 <div class="col-md-4">${WHOLESALE.company_name}</div>
	 </div>
	<br>
	<div class="row">
	 
	 <div class="col-md-2">Business type:</div>
	 <div class="col-md-4">${WHOLESALE.business_type}</div>
	 <div class="col-md-2">Address:</div>
	 <div class="col-md-4">${WHOLESALE.street_address}</div>
	 </div>
	 <br>
	 <div class="row">
	 
	 <div class="col-md-2">City:</div>
	 <div class="col-md-4">${WHOLESALE.city}</div>
	 <div class="col-md-2">State:</div>
	 <div class="col-md-4">${WHOLESALE.state}</div>
	 </div>
	 <br>
	 
	 <fmt:formatDate var="date" type="both" dateStyle="medium" timeStyle="short" value="${WHOLESALE.created_on}"/>
	 
	 <div class="row">
	 
	 <div class="col-md-2">Seat capacity:</div>
	 <div class="col-md-4">${WHOLESALE.seating_capacity}</div>
...
<%--             <form method="post">
                <div class="row">
                    ...
                    <div class="profile-work" style="margin-top: -65px;">
                            <p>Email_Address</p>
                            <a href="">${WHOLESALE.name}</a><br/>
                            <p>Contact Number</p>
                            <a href="">${WHOLESALE.contact_number}</a><br/>
