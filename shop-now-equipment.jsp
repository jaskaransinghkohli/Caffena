            ...
            <c:set var = "string3" value = "${fn:split(imagename1, ',')}" />
				<div class="row" id="cart-details" style="display: none;">
					...
					<div class="row">
						...
						<div class="col-sm-1">
							<img alt="" src="getImagebyName?imageName=${string3[0]}" style="border: 1px solid green; margin: 0px 0px 0px 0px; height:23%;" >
						</div>
						...
						<div class="col-sm-4" style="padding: 15px 0px 20px 0px">
							...
							<h5>Cart subtotal( ${ ORDER.size()} items): ₹ ${price} </h5>
						</div>
					...
					<div class="row">
						<div class="col-md-3 col-sm-3 col-xs-12">
							<div class="blog-left-section">
								...
								<a href="product-shop" style="font-size: 19px;" >Coffee Product</a>
								<div id="woocommerce_product_categories-2" class="blog-common-wide widget woocommerce widget_product_categories">
									...
									<ul class="product-categories ul-li-st">
										<li class="">
											<a href="javscript: void(0)" onclick="fun(this.val)"><input type="checkbox" name="grade_name" value="COFFEE MACHINE" style="box-sizing:border-box; ">Coffee Machine</a>
										</li>
										<li class="cat-item cat-item-37">
											<a href="javscript: void(0)" onclick="fun(this.val)"><input type="checkbox" name="grade_name" value="MANUAL BREWING" style="box-sizing:border-box; ">Manual Brewing</a>
										</li>
										<li class="cat-item cat-item-38">
											<a href="javscript: void(0)" onclick="fun(this.val)"><input type="checkbox" name="grade_name" value="AUTOMATIC BREWING" style="box-sizing:border-box; ">Automatic Brewing</a>
										</li>
										<li class="">
											<a href="javscript: void(0)" onclick="fun(this.val)"><input type="checkbox" name="grade_name" value="GRINDER" style="box-sizing:border-box; ">Grinder</a>
										</li>
										<li class="">
											<a href="javscript: void(0)" onclick="fun(this.val)"><input type="checkbox" name="grade_name" value="DRINK MIXER" style="box-sizing:border-box; ">Drink Mixer</a>
										</li>
										<li class="">
											<a href="javscript: void(0)" onclick="fun(this.val)"><input type="checkbox" name="grade_name" value="MILK STEAMER" style="box-sizing:border-box; ">Milk Steamer</a>
										</li>
										<li class="">
											<a href="javscript: void(0)" onclick="fun(this.val)"><input type="checkbox" name="grade_name" value="ACCESSORIES" style="box-sizing:border-box; ">Accessories</a>
										</li>
										<div id="woocommerce_price_filter-2" class="blog-common-wide widget woocommerce widget_price_filter">
											<div class="widget-top">
												<h3 class="widget-title">Price</h3>
											</div>
											<form method="post" action="products-on-price-range1">
												<div class="price_slider_wrapper">
													<div class="price_slider" style="display:none;"></div>
														<div class="price_slider_amount">
															<input type="text" id="min_price" name="min_price" value="1000" data-min="1000" placeholder="Min price" />
															<input type="text" id="max_price" name="max_price" value="999999" data-max="999999" placeholder="Max price" />
									...
									<div class="col-md-9 col-sm-9 col-xs-12">
										<div class="blog-right-section">
											<div class="shop-search wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
												...
												<div class="row">
													<div class="col-md-10">
													<!-- <div class=" grid__item large--one-whole medium--one-whole small--one-whole text--left">
        											    <a class="equipment-tab button active" href="#" tag="all">All</a>
            											<a class="equipment-tab button" href="#" tag="manual_brewing">Manual Brewing</a>
											            <a class="equipment-tab button" href="#" tag="grinders">Grinders</a>
											            <a class="equipment-tab button" href="#" tag="accessories">Accessories</a>
											            <a class="equipment-tab button" href="#" tag="automatic_brewing">Automatic Brewing</a>
											            <a class="equipment-tab button" href="#" tag="cold_brew">Cold Brew</a>
											          </div> -->  <!-- ravi -->
											         </div> 												
												<div class="col-md-2">
...
function fun(str){
    ...
    $("#pre").show();
   $.ajax({
  		url:"products-on-grade-or-category1", 
  		traditional: true,
  		type: 'POST',
  		data:{from:from_price,
				to: to_price,
