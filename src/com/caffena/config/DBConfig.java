...
@Configuration
@PropertySource("classpath:/caffena/configuration.properties")
@EnableTransactionManagement
@ComponentScans(value = { @ComponentScan("com.caffena.dao"),
@ComponentScan("com.caffena")})
...
public class DBConfig {
	   ...
	   public LocalSessionFactoryBean getSessionFactory() {
		  ...
		  factoryBean.setPackagesToScan(new String[]{"com.caffena.beans"});
